      ...
      <div className="p-4 sm:ml-64">
        <div className="p-4 border-2 border-zinc-500 border-dashed rounded-lg dark:border-zinc-500">
          <div className="grid grid-cols-3 gap-4 mb-4">
            ...
            <div className="flex items-center justify-center h-24 rounded-sm bg-zinc-500 dark:bg-zinc-500">
            <svg
                  className="shrink-0 w-5 h-5 text-white transition duration-75 dark:text-white group-hover:text-white dark:group-hover:text-zinc-500"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  viewBox="0 0 20 18"
            ...
            <div className="flex items-center justify-center h-24 rounded-sm bg-zinc-500 dark:bg-zinc-500">
            <svg
                  className="shrink-0 w-5 h-5 text-white transition duration-75 dark:text-white group-hover:text-zinc-500 dark:group-hover:text-zinc-500"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  viewBox="0 0 18 18"
