        ...
        <div className="relative bg-zinc-500 rounded-lg shadow dark:bg-zinc-500">
          ...
          <div className="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
            <button
              ...
              data-modal-hide="default-modal"
              type="button"
              className="text-zinc-500 bg-pink-200 font-semibold hover:bg-pink-400 focus:ring-4 focus:outline-none focus:ring-pink-300 rounded-lg  px-5 py-2.5 text-center dark:bg-pink-200 dark:hover:bg-pink-400 dark:focus:ring-pink-600"
            >
              Close
            </button>
          </div>
...
const AddProject = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    dispatch(addProject({ ...projectForm }));
    setShowModal(true);
  };
      ...
      <form onSubmit={handleSubmit}>
        <div className="grid gap-6 pb-10 md:grid-cols-3 ps-20 pe-20 mt-10 ml-60">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setProjectForm({ ...projectForm, weddingName: e.target.value })
              }
              type="text"
              id="weddingName"
        ...
        <div className="grid gap-6 pb-10 md:grid-cols-2 ps-20 pe-20  ml-60">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setProjectForm({ ...projectForm, weddingDate: e.target.value })
              }
              type="date"
              id="weddingDate"
              className="bg-white border border-gray-300 text-zinc-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-zinc-500 dark:focus:ring-blue-500 dark:focus:border-blue-500"
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setProjectForm({ ...projectForm, weddingTime: e.target.value })
              }
              type="time"
              id="weddingTime"
              className="bg-white border border-gray-300 text-zinc-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-zinc-500 dark:focus:ring-blue-500 dark:focus:border-blue-500"
        ...
        <div className="mb-6 ps-20 pe-20 ml-60">
          ...
          <input
            ...
            id="weddingLocation"
            className="bg-white border border-gray-300 text-zinc-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-zinc-500 dark:focus:ring-blue-500 dark:focus:border-blue-500"
            placeholder="San Tan Village Lake, Gilbert, AZ"
          />
        </div>
        <GradientText
          colors={["#f8fafc", "#71717a", "#1f2937", "#71717a", "#f8fafc"]}
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setProjectForm({
                  ...projectForm,
                  bride: { ...projectForm.bride, bridesNumber: e.target.value },
                })
              }
              type="tel"
              id="bridesNumber"
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setProjectForm({
                  ...projectForm,
                  bride: { ...projectForm.bride, bridesEmail: e.target.value },
                })
              }
              type="email"
              id="bridesEmail"
              className="bg-white border border-gray-300 text-zinc-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-zinc-500 dark:focus:ring-blue-500 dark:focus:border-blue-500"
              placeholder="apowell9385@yahoo.com"
            />
          </div>
        </div>
        <GradientText
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setProjectForm({
                  ...projectForm,
                  groom: { ...projectForm.groom, groomsNumber: e.target.value },
                })
              }
              type="tel"
              id="groomsNumber"
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setProjectForm({
                  ...projectForm,
                  groom: { ...projectForm.groom, groomsEmail: e.target.value },
                })
              }
              type="email"
              id="groomsEmail"
              className="bg-white border border-gray-300 text-zinc-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-zinc-500 dark:focus:ring-blue-500 dark:focus:border-blue-500"
              placeholder="jbrooks6674@yahoo.com"
            />
          </div>
        </div>
        <div className="grid gap-6 pb-10 md:grid-cols-3 ps-20 pe-20  ml-60">
          ...
          <div>
            ...
            <input
             ...
             onChange={(e) =>
               setProjectForm({
                 ...projectForm,
                 users: { ...projectForm.users, email: users.email },
               })
             }
             type="text"
             id="email"
        ...
        <button
          type="submit"
          className="text-white mb-10 brush bg-zinc-500 ml-80 hover:bg-zinc-800 focus:ring-4 focus:outline-none focus:ring-zinc-300 font-medium rounded-lg text-2xl w-full sm:w-auto px-5 py-2.5 text-center dark:bg-zinc-500 dark:hover:bg-zinc-800 dark:focus:ring-zinc-800"
        >
          Create Project
        </button>
      </form>
